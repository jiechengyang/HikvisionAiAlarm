...
namespace BytAiAlarmService.Sdk
{
	/// <summary>
	/// CHCNetSDK 的摘要说明。
	/// </summary>
    public class CHCNetSDK
    {
        ...
        **************************************************/
        ...
        public const int COMM_UPLOAD_AIOP_VIDEO = 0x4021;   //AI开放平台接入视频检测报警信息
        public const int COMM_UPLOAD_AIOP_PICTURE = 0x4022;   //AI开放平台接入图片检测报警信息
        public const int COMM_UPLOAD_AIOP_POLLING_SNAP = 0x4023;   //AI开放平台接入轮询抓图检测报警信息
        public const int COMM_UPLOAD_AIOP_POLLING_VIDEO = 0x4024;   //AI开放平台接入轮询抓图检测报警信息
        public const int COMM_FIREDETECTION_ALARM = 0x4991;   //火点检测报警信息
        public const int COMM_FACE_THERMOMETRY_ALARM = 0x4994;   //0x4994
